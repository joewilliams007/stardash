...
// The StarDash App
const starlink = "https://drive.google.com/file/d/1EaJRHD69nN8Pwj1tEvThqcr8Tk2X_NJJ/view?usp=sharing"
const starversion = "1.6.1"
...
// ADD YOUR NUMBER HERE TO GET OWNER!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	const ownerNumber = [
		`494917626388837@s.whatsapp.net`, `${botowner}`
		];
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
//-- Delay
...
//-- Get all user data
		...
		try{
			if (Number(money) < 120) {
			moneystatus = "- - - - - - - - - - - - - - - - - -\n𝑆𝑒𝑒𝑚𝑠 𝑙𝑖𝑘𝑒 𝑢 ℎ𝑎𝑣𝑒 𝑓𝑒𝑤 𝑚𝑜𝑛𝑒𝑦.\n𝑈 𝑐𝑎𝑛 𝑔𝑒𝑡 𝑆𝑡𝑎𝑟𝑑𝑎𝑠ℎ 𝑎𝑝𝑝 𝑓𝑜𝑟 𝑠𝑜𝑚 𝑓𝑟𝑒𝑒 𝑚𝑜𝑛𝑒𝑦.\n𝐷𝑜𝑤𝑛𝑙𝑜𝑎𝑑 𝑣𝑖𝑎 .𝑎𝑝𝑝\n- - - - - - - - - - - - - - - - - -"
			}
			else {
			moneystatus = "- - - - - - - - - - - - - - - - - -\n𝑈 𝑐𝑎𝑛 𝑔𝑒𝑡 𝑆𝑡𝑎𝑟𝑑𝑎𝑠ℎ 𝑎𝑝𝑝 𝑓𝑜𝑟 𝑠𝑜𝑚 𝑓𝑟𝑒𝑒 𝑚𝑜𝑛𝑒𝑦.\n𝐷𝑜𝑤𝑛𝑙𝑜𝑎𝑑 𝑣𝑖𝑎 .𝑎𝑝𝑝\n- - - - - - - - - - - - - - - - - -"
			}
...
- - - - - - - - - - - - - - - - - -
𝐻𝑎𝑣𝑒 𝑦𝑜𝑢 𝑢𝑝𝑑𝑎𝑡𝑒𝑑 𝑦𝑒𝑡
𝑡𝑜 𝑡ℎ𝑒 𝑛𝑒𝑤𝑒𝑠𝑡 𝑉𝑒𝑟𝑠𝑖𝑜𝑛 _${starversion}_ ?
𝐷𝑜𝑤𝑛𝑙𝑜𝑎𝑑 𝑣𝑖𝑎 .𝑎𝑝𝑝
- - - - - - - - - - - - - - - - - -
𝑈𝑟 𝑛𝑒𝑤 𝑀𝑜𝑛𝑒𝑦: ${newnewmoney}$
- - - - - - - - - - - - - - - - - -
